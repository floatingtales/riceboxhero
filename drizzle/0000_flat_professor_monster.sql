CREATE TYPE "public"."menu_type_enum" AS ENUM('rice_box', 'meat_only');--> statement-breakpoint
...
CREATE TABLE "riceboxhero_order" (
	...
	"discount" numeric(15, 2),
	"discountRate" numeric(5, 2),
	"serviceCharge" numeric(15, 2),
	"serviceChargeRate" numeric(15, 2),
	"tax" numeric(15, 2),
	"taxRate" numeric(5, 2),
	"orderNote" text,
	"createdAt" timestamp with time zone NOT NULL,
