	...
	return (
		...
		>
			<Group align="center" justify="space-between" mb="md">
				...
				<Group gap="xl">
					<Group gap="xs">
						<IconPackage color="var(--mantine-color-orange-6)" />
						<Stack gap="0">
					...
					<Group gap="xs">
						<IconMoneybag color="var(--mantine-color-orange-6)" />
						<Stack gap="0">
							<Text c="dimmed" size="xs">
								Today's Sales
							</Text>
			...
			>
				<Tabs.List>
					...
					<Tabs.Tab
						leftSection={<IconHistory color="var(--mantine-color-orange-5)" />}
						value={PATH_CONST.HISTORY}
					>
						History
					</Tabs.Tab>
					<Tabs.Tab
